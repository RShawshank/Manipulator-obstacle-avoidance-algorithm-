function [RRTree1,pathFound,extendFail,closestNode,newPoint]=rrtExtend3(RRTree1,RRTree2,goal,stepsize,maxFailedAttempts,threshold,circleCenter,r,searchSize,cylinderMatrix,cylinderRMatrix,cylinderHMatrix)
...
while failedAttempts<=maxFailedAttempts
    ...
    if ~checkPath3(closestNode, newPoint, circleCenter,r,cylinderMatrix,cylinderRMatrix,cylinderHMatrix) % if extension of closest node in tree to the new point is feasible
