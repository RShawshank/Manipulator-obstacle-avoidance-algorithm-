...
if display,imshow(map);rectangle('position',[1 1 size(map)-1],'edgecolor','r'); end
hold on;
...
while failedAttempts <= maxFailedAttempts  
    ...
    failedAttempts = 0;
    % 绘制路径
    if display, line([closestNode(2);newPoint(2)],[closestNode(1);newPoint(1)]);counter = counter + 1; M(counter) = getframe; end  
end
